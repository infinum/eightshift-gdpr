...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<Fragment>
			{!wrapperDisable &&
				<PanelBody title={__('Block Layout', 'eightshift-gdpr')} initialOpen={false} className="custom-highlighted-panel">
					...
					{wrapperUseShowControl &&
						<ToggleControl
							label={wrapperUse ? __('Wrapper Enabled', 'eightshift-gdpr') : __('Wrapper Disabled', 'eightshift-gdpr')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<ToggleControl
							label={wrapperUseSimple ? __('Wrapper Simple Enabled', 'eightshift-gdpr') : __('Wrapper Simple Disabled', 'eightshift-gdpr')}
								...
								<Responsive
									label={
										<Fragment>
											...
											{__('Spacing Top', 'eightshift-gdpr')}
										</Fragment>
									}
								>
								...
								<Responsive
									label={
										<Fragment>
											...
											{__('Spacing Bottom', 'eightshift-gdpr')}
										</Fragment>
									}
								>
							...
							{showWrapperSpacingTopIn &&
								<Responsive
									label={
										<Fragment>
											<Icon icon={icons.spacingTop} />
											{__('Spacing Top In', 'eightshift-gdpr')}
										</Fragment>
									}
								>
							...
							{showWrapperSpacingBottomIn &&
								<Responsive
									label={
										<Fragment>
											<Icon icon={icons.spacingBottom} />
											{__('Spacing Bottom In', 'eightshift-gdpr')}
										</Fragment>
									}
								>
								...
								<Responsive
									label={
										<Fragment>
											...
											{__('Divider Top', 'eightshift-gdpr')}
										</Fragment>
									}
								>
								...
								<Responsive
									label={
										<Fragment>
											...
											{__('Divider Bottom', 'eightshift-gdpr')}
										</Fragment>
									}
								>
										...
										<Responsive
											label={
												<Fragment>
													...
													{__('ContainerWidth', 'eightshift-gdpr')}
												</Fragment>
											}
										>
										...
										<ColorPaletteCustom
											label={
												<Fragment>
													...
													{__('Background Color', 'eightshift-gdpr')}
												</Fragment>
											}
								...
								<TextControl
									label={
										<Fragment>
											...
											{__('Block Anchor ID', 'eightshift-gdpr')}
										</Fragment>
									}
									value={wrapperId}
