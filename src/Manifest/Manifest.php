 ...
 *
 * @package Eightshift\EightshiftGdpr\Manifest
 */

declare(strict_types=1);

namespace Eightshift\EightshiftGdpr\Manifest;

use Eightshift\EightshiftGdpr\Config\Config;
use EightshiftGdprVendor\EightshiftLibs\Manifest\AbstractManifest;
