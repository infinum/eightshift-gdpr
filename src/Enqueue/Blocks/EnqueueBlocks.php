 ...
 *
 * @package Eightshift\EightshiftGdpr\Enqueue\Blocks
 */

declare(strict_types=1);

namespace Eightshift\EightshiftGdpr\Enqueue\Blocks;

use Eightshift\EightshiftGdpr\Config\Config;
use EightshiftGdprVendor\EightshiftLibs\Manifest\ManifestInterface;
use EightshiftGdprVendor\EightshiftLibs\Enqueue\Blocks\AbstractEnqueueBlocks;
